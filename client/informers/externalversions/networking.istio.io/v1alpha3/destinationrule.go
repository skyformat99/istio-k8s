...
import (
	...
	networkingistioiov1alpha3 "github.com/wallstreetcn/istio-k8s/apis/networking.istio.io/v1alpha3"
	versioned "github.com/wallstreetcn/istio-k8s/client/clientset/versioned"
	internalinterfaces "github.com/wallstreetcn/istio-k8s/client/informers/externalversions/internalinterfaces"
	v1alpha3 "github.com/wallstreetcn/istio-k8s/client/listers/networking.istio.io/v1alpha3"
...
func NewFilteredDestinationRuleInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&networkingistioiov1alpha3.DestinationRule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *destinationRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkingistioiov1alpha3.DestinationRule{}, f.defaultInformer)
}
